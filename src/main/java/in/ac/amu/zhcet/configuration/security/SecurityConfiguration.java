    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/department/{department}/courses/{course}/**")
                    .access("@permissionManager.checkCourse(#department, #course)")
                ...
                .antMatchers("/task/**").hasAnyAuthority(Roles.FACULTY, Roles.DEPARTMENT_ADMIN, Roles.DEAN_ADMIN)
                .antMatchers("/notification/{id}/**")
                    .access("@permissionManager.checkNotificationCreator(authentication, #id)")
                .antMatchers("/notification/**").hasAnyAuthority(Roles.FACULTY, Roles.DEPARTMENT_ADMIN, Roles.DEAN_ADMIN)
                .and()
                    .formLogin()
