...
public class LinkMailService {
    ...
    public void sendEmail(LinkMessage linkMessage, boolean allowUnSubscribe) {
        ...
        if (allowUnSubscribe) {
            String unSubscribeUrl = getUnSubscribeUrl(linkMessage.getRecipient());
        ...
        emailService.sendHtmlMail(linkMessage.getRecipient(), linkMessage.getSubject(), getHtml(linkMessage));
    }
