...
public class CsvParseErrorHandler {
    ...
    public static Optional<String> getInvalidFormatColumn(AbstractUploadService.ParseErrorWrapper parseErrorWrapper) {
    ...
    public static String handleError(AbstractUploadService.ParseErrorWrapper parseErrorWrapper) {
