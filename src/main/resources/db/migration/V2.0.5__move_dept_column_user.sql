ALTER TABLE user_auth ADD department_id BIGINT(20) NOT NULL;
...
ALTER TABLE user_detail DROP FOREIGN KEY FK_user_department;
ALTER TABLE user_detail DROP department_id;
