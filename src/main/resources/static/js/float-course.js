function itemTemplate(suggestion) {
    return [
        ...
        "<span class='code'>", fuzzyhound.highlight(suggestion.code, "code"), " - </span>",
        "<span class='title'><i>", fuzzyhound.highlight(suggestion.title,"title") ,"</i></span> ",
...
setsource("/department/api/courses", ["code", "title"]);
